...
export default function ArticlePage() {
  ...
  const colorClass = categoryColorClasses[article.category.slug as keyof typeof categoryColorClasses] || "bg-blue-100 text-primary";
          ...
          <header className="mb-8">
            ...
            {article.author && (
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-neutral">{article.author.name}</p>
